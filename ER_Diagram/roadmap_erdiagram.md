...
| # | รูป/โมดูล | ตารางหลัก (ตัวอย่าง) |
|---|---|---|
| M1 | **โอน/รับโอนงบประมาณ** *(เริ่มก่อน — เป็น template)* | BUDGETTRANSFER, BUDGETADJUST, BUDGETTRANSFER_CATEGORY, BUDGETTRANSFERSOURCEITEM, BUDGETTRANSFERTARGETITEM, BUDGETTRANSFERHISTORY, BUDGETRECEIVE, BUDGETRECEIVEREFUND, BUDGETRECEIVEREFUND_COSTCENTER |
| M2 | **จัดสรร/โอนจัดสรร** | BUDGETALLOCATETRANSFER (+_CATEGORY/_COSTCENTER/_COSTCENTER_NOTE), BUDGETALLOCATETRANSFERMORE (+_CATEGORY) |
| M3 | **คำของบประมาณ** | BUDGETREQUEST, BUDGETREQUESTOUTSIDE, BUDGETREQUISITION, BUDGETGOVERNMENT (+ITEM/ASSETITEM) |
| M4 | **รับงบ/รอบงบ (Receive Period)** | BUDGETRECEIVE, BUDGETRECEIVEPERIOD (+ALLOCATION/CATEGORY/REQUEST) |
| M5 | **แผนเบิกจ่าย** | BUDGETDISBURSEMENTPLAN (+ITEM/RECEIVE), BUDGETDISBURSEMENT (+ITEM/AVERAGE/ESTIMATED/OUTSIDEITEM) |
| M6 | **กันเงิน / คืนงบ** | BUDGETRESERVED (+ITEM/_CATEGORY/_BANKACCOUNT), BUDGETREFUND, BUDGETREFUNDHISTORY |
| M7 | **สินทรัพย์ (Asset)** | ASSET, ASSETCHANGE, ASSETTRANSFER(+ITEM), ASSETBORROW(+ITEM), ASSETMAINTENANCE*, ASSETREQUISITION(+ITEM), ASSETRETURN(+ITEM), ASSETWRITEOFF(+ITEM) |
| M8 | **Master data** | MASTER* (BANK/AMPHUR/ASSETTYPE/BUDGETEXPENSETYPE/ฯลฯ) + ACCOUNT_SEGMENT |
| M9 | **ผู้ใช้ / สิทธิ์ / ระบบ** | SYSTEMUSER, SYSTEMPERMISSION, ROLE assign, WORKFLOWJOBLOG, LOG_INTERFACE, CANCELREASONLOG |
